...
folder_path = 'karbytes2025_14'  # Replace the value of folder_path with your actual folder path.
output_file = 'karbytes2025_14_contents.txt'  # Replace the value of output_file with your preferred output text file path (which will overwrite that file if it exists or else generate it).
